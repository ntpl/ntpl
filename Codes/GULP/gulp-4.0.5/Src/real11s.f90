  subroutine real11s(eatom,ereal,lgrad1,lgrad2,imode)
!
...
!
  ...
  if (status/=0) call outofmemory('real11s','npotl')
!
!  Zero energies
!
  eatom = 0.0_dp
...
!
  ...
  if (status/=0) call deallocate_error('real11s','npotl')
!
!  Timing
!
  time2 = cputime()
