  subroutine manymd3(emany,esregion12,esregion2,eattach,lgrad1)
!
...
!            freedom
!
!   3/99 Created from many.f specifically for first derivative
!        only calculation -> MD
...
!   3/03 Improved distance searching algorithm included
...
!  10/09 Adding of strain derivatives to rstrdnr for EAM case fixed
...
!
  ...
  if (status/=0) call outofmemory('manymd3','npotl')
!
...
!
!  If there is no density then skip rest of working
!
...
!
!  Endif for distance check against potential 
!
            endif
!
!  End of loop over potentials
!
          enddo
!
...
!
  ...
  if (status/=0) call deallocate_error('manymd3','npotl')
!
!  Exit point
!
1000 continue
