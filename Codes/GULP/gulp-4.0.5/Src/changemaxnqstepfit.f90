  subroutine changemaxnqstepfit
!
!  Alters the size of the arrays associated with maxnq_step_fit
!
!  Conditions of use:
!
...
!
  ...
  if (ierror.ne.0) call outofmemory('changemaxnq_step_fit','sofomega_fit')
!
  return
  end
